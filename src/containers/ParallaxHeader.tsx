...
const ParallaxHeader = (props : Props) => {
  return (
    <ReactNativeParallaxHeader
      ...
      navbarColor={get(props, 'navbarColor', '#3498db')}
      ...
      renderNavBar={() => get(props, 'renderNavBar', renderNavBar)(
        props.renderLeft,
        props.renderBody,
        props.renderRight
      )}
      ...
      contentContainerStyle={get(props, 'contentContainerStyle', styles.contentContainer)}
      innerContainerStyle={get(props, 'innerContainerStyle', styles.container)}
      scrollViewProps={{
        onScrollBeginDrag: () => props.onScrollBeginDrag && props.onScrollBeginDrag(),
